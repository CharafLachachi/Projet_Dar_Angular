...
var NbClickTriggerStrategy = /** @class */ (function (_super) {
    ...
    function NbClickTriggerStrategy() {
        ...
        _this.click$ = rxjs.fromEvent(_this.document, 'click')
            .pipe(rxjs_operators.map(function (event) { return [!_this.container() && _this.isOnHost(event), event]; }), rxjs_operators.share());
    ...
    function NbHoverTriggerStrategy() {
        ...
        _this.hide$ = rxjs.fromEvent(_this.host, 'mouseleave')
            ...
            return rxjs.fromEvent(_this.document, 'mousemove')
                .pipe(rxjs_operators.debounceTime(100), rxjs_operators.takeWhile(function () { return !!_this.container(); }), rxjs_operators.filter(function (event) { return _this.isNotOnHostOrContainer(event); }));
        }));
        return _this;
    }
...
var NbHintTriggerStrategy = /** @class */ (function (_super) {
    ...
    function NbHintTriggerStrategy() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        _this.show$ = rxjs.fromEvent(_this.host, 'mouseenter')
            .pipe(rxjs_operators.delay(100), rxjs_operators.takeUntil(rxjs.fromEvent(_this.host, 'mouseleave')), 
...
var NbSelectComponent = /** @class */ (function () {
    ...
    NbSelectComponent.propDecorators = {
        ...
        "button": [{ type: i0.ViewChild, args: [NbButtonComponent, { read: i0.ElementRef },] },],
    };
...
var NbRadioGroupComponent = /** @class */ (function () {
    ...
    NbRadioGroupComponent.prototype.subscribeOnRadiosBlur = function () {
        ...
        rxjs.fromEvent(hostElement, 'focusin')
            .pipe(rxjs_operators.filter(function (event) { return hostElement.contains(event.target); }), rxjs_operators.switchMap(function () {
            return rxjs.merge(rxjs.fromEvent(_this.document, 'focusin'), rxjs.fromEvent(_this.document, 'click'));
        }), rxjs_operators.filter(function (event) { return !hostElement.contains(event.target); }), rxjs_operators.take(1))
